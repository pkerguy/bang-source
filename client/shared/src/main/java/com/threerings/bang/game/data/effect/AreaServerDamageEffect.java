 ...
 */
public class AreaServerDamageEffect extends AreaEffect
{
    ...
    public AreaServerDamageEffect()
    {
    }

    public AreaServerDamageEffect(int causer, int damage, int radius, int x, int y)
    {
        super(radius, x, y);
        this.causer = causer;
