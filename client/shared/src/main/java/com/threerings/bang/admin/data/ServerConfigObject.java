...
public class ServerConfigObject extends ConfigObject
{
    ...
    /**
     * Requests that the <code>INIT</code> field be set to the
     ...
     */
    public void setInitVersion (int value)
    {
        int ovalue = this.INIT;
        requestAttributeChange(
                INIT_VERSION, value, ovalue);
        this.INIT = value;
    }
    ...
    /**
     * Requests that the <code>SCRIP_TO_GOLD_RATE</code> field be set to the
     * specified value. The local value will be updated immediately and an
     * event will be propagated through the system to notify all listeners
     * that the attribute did change. Proxied copies of this object (on
     * clients) will apply the value change when they received the
     * attribute changed notification.
     */
    public void setExchangeTo (int newRate)
    {
        int ovalue = this.scripToGoldRate;
        requestAttributeChange(
                SCRIP_TO_GOLD_RATE, newRate, ovalue);
        this.scripToGoldRate = newRate;
    }

    /**
     * Requests that the <code>GOLD_TO_SCRIP</code> field be set to the
     * specified value. The local value will be updated immediately and an
     * event will be propagated through the system to notify all listeners
     * that the attribute did change. Proxied copies of this object (on
     * clients) will apply the value change when they received the
     * attribute changed notification.
     */
    public void setExchangeFrom (int newRate)
    {
        int ovalue = this.goldToScripRate;
        requestAttributeChange(
                GOLD_TO_SCRIP_RATE, newRate, ovalue);
        this.goldToScripRate = newRate;
    }
