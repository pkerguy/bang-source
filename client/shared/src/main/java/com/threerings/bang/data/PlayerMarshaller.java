    ...
    implements PlayerService
{
    ...
    public static final int DESTROY_ITEM = 4;
    ...
    /** The method id used to dispatch {@link #gameMasterAction} requests. */
    public static final int GAME_MASTER_ACTION = 5;

    // from interface PlayerService
    public void gameMasterAction (Handle arg1, int arg2, String arg3, long arg4, InvocationService.ConfirmListener arg5)
    {
        ...
        sendRequest(GAME_MASTER_ACTION, new Object[] {
            arg1, Integer.valueOf(arg2), arg3, Long.valueOf(arg4), listener5
        });
    }

    /** The method id used to dispatch {@link #getPosterInfo} requests. */
    public static final int GET_POSTER_INFO = 6;
    ...
    public static final int INVITE_PARDNER = 7;
    ...
    public static final int NOTE_FOLK = 8;
    ...
    public static final int PLAY_BOUNTY_GAME = 9;
    ...
    public static final int PLAY_COMPUTER = 10;
    ...
    public static final int PLAY_PRACTICE = 11;
    ...
    public static final int PLAY_TUTORIAL = 12;
    ...
    public static final int PREP_SONG_FOR_DOWNLOAD = 13;
