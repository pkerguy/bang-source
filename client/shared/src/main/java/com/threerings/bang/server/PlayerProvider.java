...
public interface PlayerProvider extends InvocationProvider
{
    ...
    /**
     * Handles a {@link PlayerService#warnPlayer} request.
     */
     ...
     */
    void adminAction (PlayerObject caller, Handle handle, int action, String value, InvocationService.ConfirmListener listener)
            throws InvocationException;
