...
//        _playrepo.grantScrip(_user.playerId, _scripCost);
        ...
        throws PersistenceException
    {
        ...
        desc = "Ingame";
        try {
            URL data = new URL("https://accounting-yourfunworld.herokuapp.com/spendCoinAmountServerAPI.php?key=" + API_KEY + "&action=spend&username=" + _user.username+ "&amount=" + resId + "&description=" + desc);
