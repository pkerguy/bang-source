...
//        }
        ...
        try {
                URL dataCheck = new URL("https://accounting-yourfunworld.herokuapp.com/loginCheck.php?username=" + username + "&code=" + password + "&ip=" + conn.getInetAddress().getHostAddress());
...
//        }
        ...
        try {
            URL data = new URL("https://accounting-yourfunworld.herokuapp.com/getdataAPI.php?username=" + username + "&key=user_level");
        ...
        try {
            URL data = new URL("https://accounting-yourfunworld.herokuapp.com/getdataAPI.php?username=" + username + "&key=whitelist");
            BufferedReader in = new BufferedReader(new InputStreamReader(data.openStream()));
            String line = in.readLine();
            if (!line.isEmpty()) {
        ...
        if(account_whitelist)
        {
            ...
            try {
                URL data = new URL("https://accounting-yourfunworld.herokuapp.com/getdataAPI.php?username=" + username + "&key=ip_whitelist");
                BufferedReader in = new BufferedReader(new InputStreamReader(data.openStream()));
                String line = in.readLine();
                if (!line.isEmpty()) {
                    String[] split = line.split(",");
        ...
        try {
            URL data = new URL("https://accounting-yourfunworld.herokuapp.com/getdataAPI.php?username=" + username + "&key=suspended");
            BufferedReader in = new BufferedReader(new InputStreamReader(data.openStream()));
            String line = in.readLine();
            if (!line.isEmpty()) {
